...
const Desc = () => {
    return (
        <div className='flex gap-8 flex-col justify-center items-center my-7 min-h-[500px]'>
            <h1 className='text-7xl text-center font-semibold'>Description</h1>
            <p className='flex flex-col gap-4 font-medium list-decimal text-center text-xl leading-10'>Wildfire is India’s oldest and most prestigious rock band competition. With prizes worth
